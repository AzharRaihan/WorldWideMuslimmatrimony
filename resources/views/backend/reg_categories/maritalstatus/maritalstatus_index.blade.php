...
@section('title', 'Maritalstatus||Category')
@push('css')
    <!-- DataTables -->
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <h4 class="m-t-0 header-title">Marital Status Category</h4>
                        <a href="{{ route('admin.maritalstatus.create') }}">
                                ...
                                @foreach ($datas as $key=>$data)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="{{ route('admin.maritalstatus.edit', $data->id) }}"><i class="fa fa-edit"></i></a>
                                            <a href="{{ route('admin.maritalstatus.show', $data->id) }}" class="px-2"><i class="fa fa-eye"></i></a>
                                            <a type="button"
                                            onclick="deletePost({{ $data->id }})">
                                            <i class="fa fa-trash"></i>
                                            </a>
                                            <form id="delete-form-{{ $data->id }}"
                                                action="{{ route('admin.maritalstatus.destroy', $data->id) }}" method="POST"
                                                style="display: none">
                                                @csrf
                                                @method('DELETE')
                                            </form>
